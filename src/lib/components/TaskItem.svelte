...
<div class="border-b border-gray-200 py-4 flex items-center gap-4">
  <Pill class="w-6 h-6 text-emerald-500" />
  ...
  <div class="flex items-center gap-2">
    {#if !task.data.validated}
      <label
        class="cursor-pointer bg-emerald-500 text-white px-3 py-1 rounded-md hover:bg-emerald-500/90"
      >
        Upload Proof
        <input
          type="file"
